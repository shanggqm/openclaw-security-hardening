...
| 3 | 你的龙虾会被策反吗？——Prompt Injection 全解 | AI 原生威胁：直接注入、间接注入、跨会话污染、工具链攻击 | 📝 计划中 |
| 4 | 你装的 Skill 安全吗？——信任链与模型安全 | Skill 供应链攻击、大小模型安全、隐藏指令审计 | 📝 计划中 |
...
- [x] 安全连载文章（第 1-2 篇：配置安全）
- [ ] 安全连载文章（第 3 篇：Prompt Injection）
- [ ] 安全连载文章（第 4 篇：信任链与模型安全）
- [ ] 安全连载文章（第 5 篇：隐私围栏）
- [ ] 威胁模型文档
- [ ] 权限最小化助手 Skill
- [ ] 沙箱配置向导 Skill
